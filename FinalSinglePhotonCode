...
namespace NationalInstruments.Examples.CountDigEvents
{
    ...
    public class MainForm : System.Windows.Forms.Form
    {
        ...
        private List<(double X, double Y)> fullScan;
        ...
        private void startButton_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                fullScanCount = GenerateCircularScan().Count + GenerateRasterScan().Count;
        ...
        private async void loopTimer_Tick(object sender, System.EventArgs e)
        {
            try
            {
                var point = fullScan[scanPosition];
                currentX = point.X;
                currentY = point.Y;

                mirrorPort.WriteLine($"xy= {currentX:F4}; {currentY:F4}");
                ...
                if (reading >= previousReading + 1)
                {
                    Console.WriteLine("FAST TEST / LIGHT DETECTED!");
                }

                previousReading = reading;

                if (scanPosition % 100 == 0)
